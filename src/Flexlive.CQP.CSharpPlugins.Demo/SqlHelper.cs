...
namespace Flexlive.CQP.CSharpPlugins.Demo
{
    ...
    public class SqlHelper
    {
        ...
        public static SqlDataReader ExecuteReader(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            string path0 = System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "MLog");
            if (!System.IO.Directory.Exists(path0))
            {
                System.IO.Directory.CreateDirectory(path0);
            }
            string file00 = System.IO.Path.Combine(path0, "log00.txt");
            System.IO.File.WriteAllText(file00, "ExecuteReader");
            System.IO.File.AppendAllText(file00, connectionString);

            SqlConnection cn = new SqlConnection(connectionString);
            System.IO.File.AppendAllText(file00, "/r/n\r\n1/r/n\r\n");
            ...
            {
                System.IO.File.AppendAllText(file00, ex.Message);
